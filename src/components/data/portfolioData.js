/**
 * @JairAmaro Esto es JSDOC, si consideras que puede ser complicado solo borralo, es un comentario, no afectará en nada
...
export const portafolioData = [
	{
		...
		descripcion:
			'Aqui ira descripccion del repo del proyecto de inegi',
		demoURL: '',
		repoURL: '',
		anim: 'fade-right',
	},
	{
		...
		descripcion:
			'Aqui ira proyecto con data de e-commerce con web scrapping wm vs ml vs amazon', 
		demoURL: '',
		repoURL: '',
		anim: 'fade-up',
